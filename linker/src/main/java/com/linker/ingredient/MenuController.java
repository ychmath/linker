...
public class MenuController {
	 ...
	 @GetMapping("/menu") public String getPath() {
		 return "/menu/menu"; 
		 }
	...
	public String write(MenuDto dto) {
		service.write(dto);
		return "redirect:menu/list"; // 메뉴 리스트 목록
	}

	@RequestMapping("/menu/list")
	public String menuList(@RequestParam(name = "p", defaultValue = "1") int page, Model m) {
		// 글이 있는지 체크
	...
	public String content(@ModelAttribute("user")LoginDto user,
			@PathVariable int menuID, Model m) {
	...
	public String deleteMenu(int menuID) {
		int i = service.deleteMenu(menuID);
		return "" + i;
	}
}

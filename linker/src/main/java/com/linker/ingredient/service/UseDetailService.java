...
public class UseDetailService {
	...
	// 식자재 인벤토리 가져오기
	public List<UseDetailDto> getInvenList(int ingredientid){
		return dao.getInvenList(ingredientid);
	}

	// 사용내역 정보 가져오기
	public UseDetailDto getInvenInfo(int inventoryid) {
		return dao.getInvenInfo(inventoryid);
	}
	
	public List<UseDetailDto> inventoryIngredient() {
		return dao.inventoryIngredient();
	}

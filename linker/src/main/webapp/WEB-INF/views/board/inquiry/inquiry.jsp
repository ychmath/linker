...
<body>
        ...
        <c:if test="${ user.role == 'admin' }">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu fade-up m-0">
              <a href="feature.html" class="dropdown-item">Feature</a> <a href="quote.html"
                class="dropdown-item">Free Quote</a> <a href="team.html"
                class="dropdown-item">Our Team</a> <a href="testimonial.html"
                class="dropdown-item">Testimonial</a> <a href="404.html"
  ...
  <div id="search" class="table-spacing">
    <form action="search">
      ...
      <input type="text" id="search_text" name="search" size="15" maxlength="40" />
    ...
    <c:if test="${count > 0 }">
      ...
      <c:forEach items="${iList }" var="inquiry">
        ...
        <tr>
          ...
          <td>
            <a href="content/${inquiry.inquirypostid }">
          ...
          <!-- 글 생성일을 출력합니다. -->
          <td>
            <fmt:formatDate value="${inquiry.creationdate }" />
          </td>
        </tr>
  ...
  <c:if test="${ user.role == 'buyer'}">
    <div id="write" class="write_ty">
      <input type="button" id="write" value="글쓰기" onclick="location.href='write'" />
    </div>
  </c:if>

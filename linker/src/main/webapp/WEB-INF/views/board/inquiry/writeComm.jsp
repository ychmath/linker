                ...
                <div class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu fade-up m-0">
                    <a href="feature.html" class="dropdown-item">Feature</a> <a href="quote.html"
                      class="dropdown-item">Free Quote</a> <a href="team.html" class="dropdown-item">Our Team</a> <a
                      href="testimonial.html" class="dropdown-item">Testimonial</a> <a href="404.html"
          ...
          <div class="card-view">
            <div class="title">
              <h3>             
                ...
                <c:if test="${dto.inquirypostid != 0 }">
                  <input type="text" name="title" class="title_in" maxlength="50"  value="[답변]"  />
                </c:if>
              </h3>
              </div>
              <div class="myinfo">
                <dl>
                  ...
                  <dd> ${user.userid}            
                    ...
                    <input type="hidden" name="re_level" value="${dto.relevel}" /></dd>
                </dl>
              </div>
              <div class="cont">
                <p>내용</p>

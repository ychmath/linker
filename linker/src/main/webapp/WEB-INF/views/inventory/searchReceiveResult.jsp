			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<div class="navbar-nav ms-auto p-4 p-lg-0">
					...
					<c:if test="${ user.role == 'seller' }">
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu fade-up m-0">
								<a href="/ingredient/ingredientList" class="dropdown-item">식자재
									목록</a> <a href="/inventory/inventoryList"
									class="dropdown-item active">재고현황</a> <a
									href="/inventory/orderList" class="dropdown-item">발주내역</a> <a
						...
						<span class="nav-item nav-link">${ user.userid } 판매자님
							환영합니다.</span>
		...
		<div id="fh5co-about" class="fh5co-section">
			...
			<div class="container">
				<div class="about-text">
					...
					<div class="content">
						<h4 class="title">해당 수령기간에 대한 재고 검색 결과입니다.</h4>
					</div>
					<c:if test="${ count != 0 }">

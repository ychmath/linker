		...
		<form action="/findpw" method="post">
			<div class="commform">
				...
				<div class="comm_field">
					<input type="text" id="userid" name="userid" class="comm_input"
						placeholder="아이디" required /> <label class="floating-label"
						for="userid">아이디</label>
				</div>
				<div class="comm_field">
					<input type="email" id="email" name="email" class="comm_input"
						placeholder="이메일" required /> <label class="floating-label"
						for="email">이메일</label>
				</div>

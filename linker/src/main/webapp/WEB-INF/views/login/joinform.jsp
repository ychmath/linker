		...
		<div class="container">
			<div class="content">
				...
				<fieldset class="userjoin">
					<legend style="color:#ffffff">회원정보 입력</legend>
				...
				<fieldset class="agrrretype">
					<div class="all-oh">
						...
						<span style="color:#ffffff">모두 동의합니다</span>
					</div>
					<fieldset class="agreech" >
						<div class="m-box">
							<div class="mandatory">
								<label for="mandatoryTerms1" style="color:#ffffff"> 
							...
							<div class="mandatory">
									...
									<label for="mandatoryTerms2"  style="color:#ffffff">개인정보 수집, 이용동의
									<strong>(필수)</strong>
								</label>
							</div>
							<div class="optional">
								 <input type="checkbox"	 id="optionalTerms1" name="optionalTerms">
								<label for="optionalTerms1" style="color:#ffffff"> 개인정보 이용 동의<strong>(선택)</strong>
								</label>
							</div>
							<div class="optional">
								 <input type="checkbox"
									id="optionalTerms2" name="optionalTerms"><label for="optionalTerms2" style="color:#ffffff"> 이벤트, 혜택정보

    ...
    <form action="/find-id" method="post">
        <div class="commform">
            ...
            <div class="comm_field">
                <input type="text" id="name" name="name" class="comm_input" placeholder="이름" required autocomplete="off" />
                <label class="floating-label" for="name">이름</label>
            </div>
            <div class="comm_field">
                <input type="email" id="email" name="email" class="comm_input" placeholder="이메일" required autocomplete="off" />

    ...
    <div class="container">
      ...
      <form action="/find-id" method="post">
        <div class="login__field">
          <input type="text" id="name" name="name" class="login__input" placeholder="이름" required autocomplete="off"/>
          <label class="floating-label" for="name">이름</label>
        </div>
        <div class="login__field">
          <input type="email" id="email" name="email" class="login__input" placeholder="이메일" required autocomplete="off"/>

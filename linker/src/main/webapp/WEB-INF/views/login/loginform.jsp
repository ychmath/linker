...
<form:form action="login" method="post" modelAttribute="command">
  <div class="container">
    ...
    <div class="login__field">
      <input type="password" id="signin-pw" class="login__input" name="password" placeholder="비밀번호" required autocomplete="off">
      <label class="floating-label" for="signin-pw">비밀번호</label>
    </div>
    <button class="submit" id="signin" type="submit">로그인</button>
    <span></span> <span id="login-alert" style="color: red; display: none; margin-top: 10px;">${loginError}</span>

        ...
        <form:form action="login" method="post" modelAttribute="command">
            <div class="commform">
                ...
                <div class="comm_field">
                    <input type="text" id="signin-id" class="comm_input" name="userid" placeholder="아이디" required autocomplete="off">
                    <label class="floating-label" for="signin-id">아이디</label>
                </div>
                <div class="comm_field">
                    <input type="password" id="signin-pw" class="comm_input" name="password" placeholder="비밀번호" required autocomplete="off">
                    <label class="floating-label" for="signin-pw">비밀번호</label>
                </div>
                <button class="submit" id="signin" type="submit">로그인</button>
                <span></span>
                <span id="login-alert" style="color: red; display: none; margin-top: 10px;">${loginError}</span>

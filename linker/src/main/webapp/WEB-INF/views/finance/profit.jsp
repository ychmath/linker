			...
			<form:form action="login" method="post" modelAttribute="command">
				<div class="container">
					...
					<div class="login__field">
						<input type="text" id="signin-id" class="login__input form-control" name="userid"
							placeholder="아이디" required autocomplete="off">
						<label class="floating-label" for="signin-id">아이디</label>
					</div>
					<div class="login__field">
						<input type="password" id="signin-pw" class="login__input form-control" name="password"
							placeholder="비밀번호" required autocomplete="off"> <label class="floating-label"
							for="signin-pw">비밀번호</label>
					</div>
					...
					<div id="link-menu">
						<a href="/find-id">아이디 찾기</a> <a href="/findpw">비밀번호 찾기</a> <a href="/joinform">회원가입</a>
					</div>
				</div>
			</form:form>
			<script>

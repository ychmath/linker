...
<body>
	<div class="center-wrapper content-wrapper">
		<form id="updateIngredient" method="post"
			...
			<div class="commform">
				<h3>선택한 식자재를 수정합니다.</h3>
				<br>
				<div class="comm_field">
					<input type="hidden" name="_method" value="put"/> <span>식자재명:</span><input
						type="text" name="ingredientname" value=${ dto.ingredientname } style="text-align: center;">
				</div>
				<div class="comm_field">
					<span>단위: </span> <span id="targetUnit" style="display: none;">${ dto.unit }</span>
					<select name="unit" id="unit"  style="text-align: center;" >
				...
				<div class="comm_field">
					<span>유통기한: </span> <input type="date" name="exp"
						value="${ dto.exp }"  style="text-align: center;" >
				</div>
				<input class="submit" type="button" id="save" value="수정">

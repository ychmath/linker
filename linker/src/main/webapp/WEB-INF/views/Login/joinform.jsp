        ...
        <div class="user-details">
          <table>
            <tr>
              <td>이름</td>
              <td>
                <input type="text" name="name" id="name" placeholder="실명" required>
                <div id="name_msg"></div>
              </td>
            </tr>
            <tr>
              <td>아이디</td>
              <td>
                <input type="text" name="userid" id="userid" placeholder="6~20자 이내" required>
            ...
            <tr>
              <td>비밀번호</td>
              <td>
                <input type="password" name="password" id="password" placeholder="6~20자 이내, 영문대소문자/숫자/특수문자 중 2가지 조합" required>
      ...
      $("#joinForm").submit(function() {
      	// 비밀번호 검증
      	  ...
      	  if (!validateEmail($("#email").val())) {
      	    $("#email_msg").html("이메일 형식이 올바르지 않습니다. 'id@domain'이 포함된 이메일을 적어주세요");
      	    return false;
      	  } else {
